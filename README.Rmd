...
met_avg_temp_by_state_lz <- met_avg_temp_by_state_lz |> mutate(avg_temp =
  ifelse(met_avg_temp_by_state_lz$temp < 20, 'low', ifelse(met_avg_temp_by_state_lz$temp < 25, 'Mid', 'High')))
